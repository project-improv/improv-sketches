...
from GLM.synthetic.sampling_base import gen_hamming_figure, vary_double

"""
Screen for optimal λ1.
"""
...
if __name__ == '__main__':
    ...
    def run_and_plot(name, sp, params_base, params_θ):
        θ_fitted, θ_gnd = vary_double(name, sp, 'λ1', λ_sp, params_base, params_θ, rep=5)
